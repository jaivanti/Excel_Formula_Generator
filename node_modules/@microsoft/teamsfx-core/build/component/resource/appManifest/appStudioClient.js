...
(function (AppStudioClient) {
     ...
     */
    function createRequesterWithToken(appStudioToken, _region) {
    ...
    async function getApp(teamsAppId, appStudioToken, logProvider) {
        ...
        try {
            ...
            if (region) {
                try {
                    response = await utils_1.RetryHandler.Retry(() => requester.get(`/${region}/api/appdefinitions/${teamsAppId}`));
                }
                catch (e) {
        ...
        try {
            ...
            if (response && response.data) {
                if (response.data.error) {
                    ...
                    error.name = response === null || response === void 0 ? void 0 : response.data.error.code;
        ...
        try {
            ...
            if (response && response.data) {
                if (response.data.error || response.data.errorMessage) {
                    ...
                    error.name = (_d = response.data.error) === null || _d === void 0 ? void 0 : _d.code;
                    error.response = response;
                    error.request = response.request;
